...
function createAccountsTable() {
  ...
  <tr>
    ...
    <td>${account.email}</td>
    <td>${account.phone}</td>
    <td><button data-id="${i}" class="edit-btn btn btn-sm btn-warning form-contorl">Edit</button></td>
    <td><button data-id="${i}" class="delete-btn btn btn-sm btn-danger form-contorl">Delete</button></td>
</tr>
`;
  }
